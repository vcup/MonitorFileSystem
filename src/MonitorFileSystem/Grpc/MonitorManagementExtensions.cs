...
public static class MonitorManagementExtensions
{
    ...
    public static bool TryGetWatcher(this IMonitorManager manager, GuidRequest request,
    ...
    public static bool TryGetGroup(this IMonitorManager manager, GuidRequest request,
